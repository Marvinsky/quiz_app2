package com.utec.android.quiz2;
...
public class MainActivity extends AppCompatActivity {
    ...
    final int Q2_ANSWER = R.id.question_2_third_logo_radio;
    final String Q4_ANSWER = "colombia";
    final int Q5_ANSWER = R.id.question_5_third_radio;
    final String Q6_ANSWER = "red";
    final String Q7_ANSWER = "india";
